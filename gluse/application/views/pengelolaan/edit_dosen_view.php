...
<form class="form-horizontal form " action="<?=$url_submit?>" enctype="multipart/form-data" method="post">
	<div class="control-group">
	  <label for="typeahead" class="control-label">NIP</label>
	  <div class="controls">
	  	<input name="nip" type="text" value="<?=$data['nip']?>" data-items="4" data-provide="typeahead" id="typeahead" class="span4 typeahead">
	...
	<div class="form-actions">
		...
		<a class="url_back" href="<?=$url_dosen?>"><button name="back" class="btn ">&nbsp; Back &nbsp;</button></a>
	</div>
