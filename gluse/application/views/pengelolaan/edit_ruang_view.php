...
<form class="form-horizontal form " action="<?=$url_submit?>" enctype="multipart/form-data" method="post">
	...
	<div class="control-group">
	  <label for="typeahead" class="control-label">Kapasitas</label>

	  <div class="controls">
	  	<input name="kapasitas" type="text" value="<?=$data['kapasitas']?>" data-items="4" data-provide="typeahead" id="typeahead" class="span1 typeahead">
		<span class="help-inline">*</span>
	  </div>
	</div>	
	
	<div class="control-group">
		<label class="control-label">Ruang Cadangan</label>
		<div class="controls">
			<?=$rd_iscad?>
		</div>
	</div>
	...
	<div class="form-actions">
		...
		<a class="url_back" href="<?=$url_ruang?>"><button name="back" class="btn ">&nbsp; Back &nbsp;</button></a>
	</div>
