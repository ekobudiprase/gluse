...
<table class="table table-bordered table-striped table-condensed table-nonfluid" style="overflow:;width:200%;">
	...
	<tbody>
		...
		if (!empty($data)) {
			foreach ($data as $key => $value) { 
				...
				<tr>
					...
					<td class="center">
						...
						<a href="<?=$url_del?>" id="<?=$value['id']?>" class="btn btn-danger konfirmdel"><i class="icon-trash icon-white"></i> </a>
			...
			?>
			<tr>
				<td colspan="6" style="text-align:center;font-style:oblique"> -- Data tidak ada --</td>                                     
			</tr>
			<?php
		} 
		?>
