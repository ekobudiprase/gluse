...
<div class="alert alert-block " <?=$display_warning_nokelas?>>
	<button data-dismiss="alert" class="close" type="button"><i class="icon-remove"></i></button>
	<h4 class="alert-heading">Warning!</h4><p>Kelas belum dibuat.</p>	
</div>
...
<div class="btn_add">
	<a href="<?=$url_list_class?>">
		<button class="btn btn-success">Daftar kelas</button>
	</a>
	<a href="<?=$url_generate_class?>">
		<button class="btn btn-success">Generate kelas</button>
	</a>
</div>
...
<table class="table table-bordered table-striped table-condensed table-nonfluid" style="overflow:;width:200%;">
	<thead>
		<tr>
			...
			<th>Mata kuliah</th>
			<th class="span1">Maksimal kelas</th>
