...
<form class="form-horizontal form " action="<?=$url_submit?>" enctype="multipart/form-data" method="post">
	...
	<div class="control-group">
	  ...
	  <div class="controls">
		<input name="jml_individu" type="text" value="20" data-items="1" data-provide="typeahead" id="typeahead " class="span2 typeahead layer_formation" >
	...
	<div class="control-group">
	  ...
	  <div class="controls">
		<input name="generation" type="text" value="15" data-items="4" data-provide="typeahead" id="typeahead" class="span1 typeahead">
		<!-- <p class="help-block">Start typing to activate auto complete!</p> -->
	  </div>
	</div>
